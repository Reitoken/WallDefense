...
- 25 automated tests passing (`Health`, `Hero`, `Weapons`, `Patterns`, `Monsters`, `Stage`).
- **Next: Step 5** — the wall + the loop: `AWDWall` (+skills), victory/defeat, stars from wall HP, `AWDStageGameMode`, loading screen + `UWDPreloadSubsystem`. Milestone: full playable loop in debug.
